...
def L6470_move(step):
  ...
  # 送信バイトデータ生成。
  n_step_1   =  (0xFF00000000 & n_step) >> 32 
  n_step_2   =  (0x00FF000000 & n_step) >> 24 
  n_step_3   =  (0x00FF0000 & n_step) >> 16 
  n_step_4   =  (0x00FF00 & n_step) >> 8 
  n_step_5   =  (0x00FF & n_step) 
  ...
  L6470_write(n_step_4)
  L6470_write(n_step_5)
